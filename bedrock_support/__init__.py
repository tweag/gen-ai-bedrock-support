...
class Model:
    ...
    invoke_fn: Callable[[object, str, str], str]

class Models(enum.Enum):
    LLAMA2 = Model(
        id="meta.llama2-70b-chat-v1",
        price_per_1k_input_tokens=0.00195,
        price_per_1k_output_tokens=0.00256,
        invoke_fn=invoke_llama2
    )
    CLAUDE3 = Model(
        id="anthropic.claude-3-sonnet-20240229-v1:0",
        price_per_1k_input_tokens=0.003,
        price_per_1k_output_tokens=0.015,
        invoke_fn=invoke_claude3
    )
